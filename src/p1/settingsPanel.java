...
// 		frame.setIconImage(demoIcon);
 		...
 		Image img1 = new ImageIcon( this.getClass().getResource("/Images/ToggleOFF.png")).getImage(); // removed that .getClass part from the previous buttons
...
//		new settingsPanel();
 ...
 public static class pauseResumeHandler implements ActionListener{
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			Image img2 = new ImageIcon(this.getClass().getResource("/Images/ToggleON.png")).getImage();  // removed that .getClass part from the previous buttons
